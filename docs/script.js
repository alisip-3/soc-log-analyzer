...
document.getElementById('downloadPdfBtn').addEventListener('click', async () => {
    ...
    `;
    // Hide via stacking (z-index), NOT extreme off-screen coordinates —
    // html2canvas fails silently (blank capture) on elements positioned
    // tens of thousands of pixels off-canvas.
