...
### 1️⃣ Home Screen
![Home](https://github.com/alisip-3/soc-log-analyzer/blob/main/pcap_full_test/images/01-home.png)

### 2️⃣ Upload a PCAP File
![Upload](https://github.com/alisip-3/soc-log-analyzer/blob/main/pcap_full_test/images/02-pcap-upload.png)

### 3️⃣ Automatic Threat Detection
![Findings](https://github.com/alisip-3/soc-log-analyzer/blob/main/pcap_full_test/images/03-pcap-finding.png)
*It found suspicious ports, external C2 connections, and malware indicators.*

### 4️⃣ AI Writes the Report
![Report](https://github.com/alisip-3/soc-log-analyzer/blob/main/pcap_full_test/images/04-pcap-report.png)
